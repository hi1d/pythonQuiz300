...
import csv
f = open("/Users/gimgunwoo/Desktop/test", mode="wt", encoding="utf-8")
f.write("005930\n")
f.write("005380\n")
f.write("035420")
f.close()
...
f = open("/Users/gimgunwoo/Desktop/test",
         mode="wt", encoding="cp949", newline='')
writer = csv.writer(f)
...
f = open("/Users/gimgunwoo/Desktop/test.txt", encoding="utf-8")
...
data = {'삼성전자': 5930, '현대차': 5380, 'NAVER': 35420}
for line in lines:
    code = line.strip()     # '\n'
    k, v = line.split()
    data[k] = v
